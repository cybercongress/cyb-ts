    ...
    <ActionBar>
        <ActionBarContentText flexDirection="column">
            <div className="text-default">
                Your TX has been broadcast to the network. It is waiting to be
                mined & confirned.
            </div>
            <div className="text-default">
                Check TX status:{' '}
...
export class ActionBarContainer extends Component {
    ...
    render() {
        ...
        const btnConfirm =
            round >= minRound && round <= maxRound - 1 && amount > 0;
        ...
        if (step === 'succesfuuly') {
            return (
                <Succesfuuly hash={tx} onClickBtn={this.onClickSaveAddress} />
            );
        }
