...
let CHAIN_PARAMS = {
  ...
  DENOM_CYBER_G: `GBOOT`,
  CYBER_NODE_URL_API:
    process.env.CYBER_NODE_URL_API || 'http://localhost:26657', //'https://rpc.bostrom.cybernode.ai',
  CYBER_WEBSOCKET_URL:
    process.env.CYBER_WEBSOCKET_URL ||
    'wss://rpc.bostrom.cybernode.ai/websocket',
  CYBER_NODE_URL_LCD:
    process.env.CYBER_NODE_URL_LCD || 'http://localhost:1317/', //'https://lcd.bostrom.cybernode.ai',
  CYBER_INDEX_HTTPS:
    process.env.CYBER_INDEX_HTTPS || 'http://localhost:8090/v1/graphql',
  //'https://index.bostrom.cybernode.ai/v1/graphql',
  CYBER_INDEX_WEBSOCKET:
    process.env.CYBER_INDEX_WEBSOCKET || 'ws://localhost:8090/v1/graphql',
