        ...
        {availableStake > 0 && (
            <div>
                ...
                <div style={{ marginTop: '25px', marginBottom: 10 }}>
                    Enter the amount of ATOMs you wish to send to
                    Cyber~Congress:
                </div>
                ...
                <h6 style={{ margin: 20 }}>
                    The fees you will be charged by the network on this
                    transaction will
    ...
    <ContainetLedger onClickBtnCloce={onClickBtnCloce}>
        <div className="text-align-center">
            <h3 style={{ marginBottom: 20 }}>
                Please confirm the transaction data matches what is displayed on
                your device.
            </h3>
        </div>
    ...
    <ContainetLedger onClickBtnCloce={onClickBtnCloce}>
        ...
        >
            ...
            >
                ...
                This might take a few moments depending on the transaction fees
                used.
            </span>
            <Loading />
        </div>
...
export const StartState = ({ onClickBtn, valueSelect, onChangeSelect }) => (
    <ActionBar>
        <ActionBarContentText>Contribute ATOMs</ActionBarContentText>
...
export const SendAmount = ({ onClickBtn, address, onClickBtnCloce }) => (
    <div className="container-action height50 box-shadow-1px">
        <div
            style={{ position: 'absolute', padding: '0 5px', right: 3, top: 5 }}
        >
            <span>
                [
                <a
            ...
            <div className="container-send">
                <div>
                    <div>
                        ...
                        >
                            Send any amount of ATOMs directly to cyber~Congress
                            multisig by your using Cosmos wallet
                        </span>
                        <div
