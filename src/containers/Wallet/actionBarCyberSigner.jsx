...
function ActionBarCyberSigner({ updateAddress, updateBalance, selectAccount }) {
  const { cyberSigner, updateValueTxs, updateCallbackSigner } = useContext(
    AppContextSigner
  );
...
export default ActionBarCyberSigner;
